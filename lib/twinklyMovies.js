 ...
 */
function generateBlueWhiteTwinkle(twinkly) {
...
function generateTwinkle(twinkly, baseColor, secondColor) {
    ...
    frames.push(twinkly.generateFullFrame(baseColor));
    ...
    const previous = twinkly.generateFullFrame(baseColor);
    ...
    frames.push(twinkly.generateFullFrame(secondColor));
    frames.push(twinkly.generateFullFrame(secondColor));
    frames.push(twinkly.generateFullFrame(secondColor));
