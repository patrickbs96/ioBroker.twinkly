...
const apiObjectsMap = {
    details : {
        ...
        child  : {
            base_leds_number    : {id: 'baseLedsNumber',    name: 'Base LEDs Number',    type: 'number',                     deprecated: '2.8.3'},
            ...
            led_version         : {id: 'ledVersion',        name: 'LED Version',         type: 'number',                     deprecated: '2.8.3'},
            mac                 : {id: 'mac',               name: 'MAC'},
            ...
            product_version     : {id: 'productVersion',    name: 'Product Version',                                         deprecated: '2.8.3'},
            product_code        : {id: 'productCode',       name: 'Product Code'},
            rssi                : {id: 'rssi',              name: 'RSSI',                type: 'number',                     deprecated: '2.8.3'},
    ...
    ledEffect : {
        ...
        child  : {
            ...
            effect_id : {id: 'ledEffectEId', name: 'LED Effect Effect Id', hide : true, type: 'number', exclude: ['states'], deprecated: '2.8.3'},
    ...
    ledMode : {
        ...
        child  : {
            ...
            id        : {id: 'id',       name: 'Id',        type: 'number', hide: true, deprecated: '2.8.3'},
            name      : {id: 'name',     name: 'Name',                      hide: true, deprecated: '2.8.3'},
            unique_id : {id: 'uniqueId', name: 'Unique Id',                 hide: true, deprecated: '2.8.3'},
            shop_mode : {id: 'shopMode', name: 'Shop',      type: 'number', hide: true},

            // Active Movie in Mode "playlist"
            movie : {
                parent : {id: 'movie', name: 'Movie', hide: true, deprecated: '2.8.3'},
                child  : {
            ...
            // Color configuration
            color_config : {
                parent : {id: 'colorConfig', name: 'Color Config', hide: true, deprecated: '2.8.3'},
                child  : {
            ...
            musicreactive_config : {
                parent : {id: 'musicReactiveConfig', name: 'Music Reactive Config', hide: true, deprecated: '2.8.3'},
                child  : {
    ...
    mqtt : {
        ...
        child  : {
            ...
            encryption_key_set  : {id: 'encryptionKeySet',  name: 'Encryption-Key set',               type: 'boolean', deprecated: '2.8.3'}
        },
        expandJSON: true
    },
    name : {
