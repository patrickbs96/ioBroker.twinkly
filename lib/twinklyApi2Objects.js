...
const apiObjectsMap = {
    details : {
        ...
        child  : {
            ...
            hw_id               : {id: 'hwId',              name: 'Hardware ID',                         role: 'value.hex'},
            ...
            load_lvl            : {id: 'loadLvl',           name: 'Load Level',          type: 'number',                     newSince: '2.8.18'},
            mac                 : {id: 'mac',               name: 'MAC',                                 role: 'value.hex'},
            ...
            rssi                : {id: 'rssi',              name: 'RSSI',                type: 'number', unit: 'dBm',        deprecated: '2.6.6'},
            ...
            uptime              : {id: 'uptime',            name: 'Uptime',              type: 'number', role: 'value.uptime', unit: 'hours'},
    ...
    ledBri : {
        ...
        child  : {
            value : {id: 'ledBri',     name: 'LED Brightness',      write: true, writeSlave: true, type: 'number', role: 'level.dimmer', min: -1, max: 100},
    ...
    ledEffect : {
        ...
        child  : {
            preset_id : {id: 'ledEffect',    name: 'LED Effect',           write: true, type: 'number', newSince: '2.4.0', exclude: ['states']}, // deprecated fw=2.6.6, fwFamily=G
    ...
    ledMode : {
        ...
        child  : {
            mode : {id: 'ledMode', name: 'LED Mode', write: true, role: 'state', def: twinkly.lightModes.value.off, states: twinkly.lightModes.text, native: {'lastModeOn': 'string'}},

            // Active Movie in Mode "movie"
            id          : {id: 'id',         name: 'Id',        type: 'number', hide: true,                    filter: {mode: 'movie'}},
            name        : {id: 'name',       name: 'Name',                      hide: true, newSince: '2.4.0', filter: {mode: 'movie'}},
            unique_id   : {id: 'uniqueId',   name: 'Unique Id',                 hide: true, newSince: '2.4.0', filter: {mode: 'movie'}},
    ...
    ledPlaylist : {
        ...
        child  : {
            id        : {id: 'ledPlaylist',         name: 'LED Playlist',          write: true, type: 'number', exclude: ['states']},
    ...
    ledSat : {
        ...
        child  : {
            value : {id: 'ledSat',     name: 'LED Saturation',      write: true, writeSlave: true, type: 'number', role: 'level.dimmer', min: -1, max: 100},
    ...
    mqtt : {
        ...
        child  : {
            ...
            encryption_key_set  : {id: 'encryptionKeySet',  name: 'Encryption-Key set',               type: 'boolean', deprecated: '2.5.9'}
        },
        expandJSON: true
    },
    name : {
    ...
    networkStatus : {
        ...
        child  : {
            ...
            station : {
                ...
                child  : {
                    connected_bssid : {id: 'connectedBssid', name: 'Connected BSSID', role: 'value.hex',           newSince: '2.8.9'},
                    ip              : {id: 'ip',             name: 'IP'},
                    ...
                    rssi            : {id: 'rssi',           name: 'RSSI',            type: 'number', unit: 'dBm', newSince: '2.4.0'},
            ...
            ap : {
                ...
                child  : {
                    ...
                    password_changed : {id: 'passwordChanged', name: 'Password Changed', type: 'boolean', newSince: '2.4.0', ignore: {create: true, deprecated: true}},
                    ssid             : {id: 'ssid',            name: 'SSID'},
