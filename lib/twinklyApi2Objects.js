...
const apiObjectsMap = {
    details : {
        ...
        child  : {
            ...
            wire_type           : {id: 'wireType',          name: 'Wire Type',           type: 'number',                     newSince: '2.7.3', deprecated: '2.8.11'},
            ...
            group : {
                ...
                child  : {
                    ...
                    size        : {id: 'size',       name: 'Size',        type: 'number', newSince: '2.8.15'},
                    offset      : {id: 'offset',     name: 'Offset',      type: 'number', newSince: '2.8.15'},
                    uid         : {id: 'uid',        name: 'UID',                                                            deprecated: '2.6.6', ignore: {deprecated: true}, hint: 'Unknown availablilty. Sometimes available.'}
                },
                expandJSON: false
            },
            ...
            pwr: {
                parent : {id: 'power', name: 'Power', newSince: '2.8.15', family: 'T'},
                child  : {
    ...
    mqtt : {
        ...
        child  : {
            ...
            enabled             : {id: 'enabled',           name: 'Enabled',             write: true, type: 'boolean', newSince: '2.8.15'},
