...
const apiObjectsMap = {
    details : {
        ...
        child  : {
            base_leds_number    : {id: 'baseLedsNumber',    name: 'Base LEDs Number',    type: 'number',                     deprecated: '2.7.1'},
            ...
            led_version         : {id: 'ledVersion',        name: 'LED Version',         type: 'number',                     deprecated: '2.7.1'},
            mac                 : {id: 'mac',               name: 'MAC'},
            ...
            product_version     : {id: 'productVersion',    name: 'Product Version',                                         deprecated: '2.7.1'},
            product_code        : {id: 'productCode',       name: 'Product Code'},
            rssi                : {id: 'rssi',              name: 'RSSI',                type: 'number',                     deprecated: '2.7.1'},
            serial              : {id: 'serial',            name: 'Serial',                                                  newSince: '2.8.3'},
            uid                 : {id: 'uid',               name: 'UID',                                                     newSince: '2.8.4', family: 'G', ignore: true, hint: 'Unknown availablilty. Sometimes available.'},
            uptime              : {id: 'uptime',            name: 'Uptime'},
            uuid                : {id: 'uuid',              name: 'UUID'},
            wire_type           : {id: 'wireType',          name: 'Wire Type',           type: 'number',                     newSince: '2.7.3'},
    ...
    ledColor : {
        ...
        child  : {
            ...
            hex        : {id: 'hex',   name: 'Hex',   type: 'string', role: 'level.color.hex',        write: true,                   ignore: true}
        },
    ...
    ledEffect : {
        ...
        child  : {
            preset_id : {id: 'ledEffect',    name: 'LED Effect',           write: true, type: 'number', exclude: ['states']},
            effect_id : {id: 'ledEffectEId', name: 'LED Effect Effect Id', hide : true, type: 'number', exclude: ['states'], deprecated: '2.7.1'},
            unique_id : {id: 'ledEffectUID', name: 'LED Effect Unique ID', hide : true}
        },
        expandJSON: true
    },
    ledLayout : {
    ...
    ledMode : {
        ...
        child  : {
            ...
            id        : {id: 'id',       name: 'Id',        type: 'number', hide: true, deprecated: '2.7.1'},
            name      : {id: 'name',     name: 'Name',                      hide: true, deprecated: '2.7.1'},
            unique_id : {id: 'uniqueId', name: 'Unique Id',                 hide: true, deprecated: '2.7.1'},
            shop_mode : {id: 'shopMode', name: 'Shop',      type: 'number', hide: true},

            // Active Movie in Mode "playlist"
            movie : {
                parent : {id: 'movie', name: 'Movie', hide: true, deprecated: '2.7.1'},
                child  : {
            ...
            // Color configuration
            color_config : {
                parent : {id: 'colorConfig', name: 'Color Config', hide: true, deprecated: '2.7.1'},
                child  : {
                    ...
                    white      : {id: 'w',   name: 'White', type: 'number', hide: true},
            ...
            musicreactive_config : {
                parent : {id: 'musicReactiveConfig', name: 'Music Reactive Config', hide: true, deprecated: '2.7.1'},
                child  : {
    ...
    ledMovie : {
        ...
        child  : {
            id        : {id: 'ledMovie', name: 'LED Movie', write: true, type: 'number', exclude: ['states']},
    ...
    ledPlaylist : {
        ...
        child  : {
            id        : {id: 'ledPlaylist',         name: 'LED Playlist',          write: true, type: 'number'},
    ...
    mqtt : {
        ...
        child  : {
            ...
            encryption_key_set  : {id: 'encryptionKeySet',  name: 'Encryption-Key set',               type: 'boolean', deprecated: '2.7.1'}
        },
        expandJSON: true
    },
    name : {
        ...
        child  : {
            ...
            station : {
                ...
                child  : {
                    ...
                    status          : {id: 'status',         name: 'Status',                           deprecated: '2.7.1'},
                },
                expandJSON: true
            },
            ap : {
                ...
                child  : {
                    ...
                    password_changed : {id: 'passwordChanged', name: 'Password Changed', type: 'boolean', deprecated: '2.8.3'},
                    ssid             : {id: 'ssid',            name: 'SSID'},
