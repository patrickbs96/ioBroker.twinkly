    ...
    ledMode : {
        ...
        child  : {
            ...
            movie : {
                ...
                parent : {id: 'movie', name: 'Movie', hide: true, newSince: '2.4.0'},
                child  : {
            ...
            color_config : {
                ...
                parent : {id: 'colorConfig', name: 'Color Config', hide: true, newSince: '2.4.0'},
                child  : {
            ...
            musicreactive_config : {
                ...
                parent : {id: 'musicReactiveConfig', name: 'Music Reactive Config', hide: true, newSince: '2.4.0'},
                child  : {
