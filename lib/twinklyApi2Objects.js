...
const apiObjectsMap = {
    ...
    ledEffect : {
        ...
        child  : {
            preset_id : {id: 'ledEffect',    name: 'LED Effect',           write: true, type: 'number', exclude: ['states'], newSince: '2.4.0'}, // deprecated fw=2.6.6, fwFamily=G
            effect_id : {id: 'ledEffectEId', name: 'LED Effect Effect Id', hide : true, type: 'number', exclude: ['states'], deprecated: '2.6.6'},
    ...
    ledMode : {
        ...
        child  : {
            ...
            id        : {id: 'id',       name: 'Id',        type: 'number', hide: true,                    deprecated: '2.6.6'},
            ...
            movie : {
                // deprecated since 2.6.6, available in ([fw=2.8.4, fwFamily=G], [fw=2.8.9, fwFamily=M], [fw=2.8.9, fwFamily=F])
                parent : {id: 'movie', name: 'Movie', hide: true, newSince: '2.4.0', ignore: true},
                child  : {
            ...
            // Color configuration
            color_config : {
                // deprecated since 2.6.6, available in ([fw=2.8.9, fwFamily=F], [fw=2.8.9, fwFamily=S], [fw=2.8.9, fwFamily=G], [fw=2.8.9, fwFamily=M])
                parent : {id: 'colorConfig', name: 'Color Config', hide: true, newSince: '2.4.0', ignore: true},
                child  : {
                    ...
                    white      : {id: 'w',   name: 'White', type: 'number', hide: true, filter: {name: 'led_profile', val: 'RGBW'}}
                },
                expandJSON: false
            },

            musicreactive_config : {
                // deprecated in [(2.7.1), [fw=2.6.6, fwFamily=G]), available in ([fw=2.8.9, fwFamily=G])
                parent : {id: 'musicReactiveConfig', name: 'Music Reactive Config', hide: true, newSince: '2.4.0', ignore: true},
                child  : {
