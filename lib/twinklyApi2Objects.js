...
const apiObjectsMap = {
    ...
    ledMode : {
        ...
        child  : {
            ...
            id          : {id: 'id',         name: 'Id',        type: 'number', hide: true,                    filter: {mode: 'movie'}}, // deprecated fw=2.6.6, fwFamily=G
            name        : {id: 'name',       name: 'Name',                      hide: true, newSince: '2.4.0', filter: {mode: 'movie'}}, // deprecated fw=2.6.6, fwFamily=G
            unique_id   : {id: 'uniqueId',   name: 'Unique Id',                 hide: true, newSince: '2.4.0', filter: {mode: 'movie'}}, // deprecated fw=2.6.6, fwFamily=G
