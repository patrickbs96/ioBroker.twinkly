...
const apiObjectsMap = {
    ...
    ledEffect : {
        ...
        child  : {
            preset_id : {id: 'ledEffect',    name: 'LED Effect',           write: true, type: 'number', newSince: '2.4.0'}, // deprecated fw=2.6.6, fwFamily=G
    ...
    ledMovie : {
        ...
        child  : {
            id        : {id: 'ledMovie', name: 'LED Movie', write: true, type: 'number'},
